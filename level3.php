...
<?php
$Hero = new Hero(6000, 0, 'Main de la justice', 600, 'Armure Ygdrasil', 1000);
$Orc = new Orc(2500, 0, 1000, 1700);
...
<h1 class="mainTitle mt-4 mb-2">Le donjon de Mordrynn</h1>
    <h2 class="subTitle mb-5">Niveau 3</h2>
    <div class="container">
        ...
        <div class="row justify-content-center mb-4">
            <div class="col-12 col-md-6 text-center">
                <?php if ($Orc->getHealth() <= 0) { ?>
                    <p class="winText">Victoire ! Vous avez terminé le jeu :)</p>
                <?php } else { ?>
